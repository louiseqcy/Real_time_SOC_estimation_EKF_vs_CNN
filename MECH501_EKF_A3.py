...
# Interpolated model parameters - Looks Good Except voc_from_soc_temp lookup table
...
# === Noise parameters ===
R = np.array([[0.002**2]]) #5mV precision
sigma_i = 0.25 # 250mA precision
Qp = np.diag([
    1e-5,   # q
    1e-6,   # vR1
    1e-4,   # vR2
    1e-7,   # vh
    1e-3,   # vR0 (often less important if modeled directly)
    1e-4,   # gamma
    1e-3,   # M
    1e-3    # eta_tilda
])
